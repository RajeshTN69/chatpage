...
document.getElementById('callButton').addEventListener('click', function() {
    const phoneNumber = "8220851845"; // Replace with the desired phone number
...
// Function to automatically greet the user
function greetUser() {
...
function getAIResponse(userMessage) {
    // Simple responses for demonstration; expand as needed
    const responses = {
        ...
        'help me for calucations':'ok i can help you in calculations .ask some questions?',
        ...
        ,
        'what is your name':'I was name as Pheniox by rajesh',
    ...
    // Return response based on user message or default response
